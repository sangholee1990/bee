 ...
 <div id="wrap">
	 ...
	 <div id="content">
	   <ul class="side_nav">
		   ...
		   <li><a class="side_nav_one">꿀벌양봉지식</a></li>
	 ...
	 <iframe id="iframe4" width="60%" height="800px" src="../bbs/board.php?bo_table=beeinfo" name="mainframe3"  scrolling="no" style="border:0px solid #ddd; scrolling=no" frameborder="0"></iframe>
