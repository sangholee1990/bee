 ...
 <div id="wrap">
	 <div id="header">
		<div class="util_log">
			...
			<a href="../bbs/logout.php"><img class="logout" src="images/ma_sub/logout.gif" alt="로그아웃"/></a>
		</div><!-- util_log -->
	 ...
	 <div id="content">
	   <ul class="side_nav">
		   <li><a  class="side_nav_one" href="#">밀원식물지식</a></li>
		   <li><a href="./ma_sub1.php">꿀벌양봉지식</a></li>
		   <li><a href="./ma_sub2.php">공지사항</a></li>
	   </ul>
	 </div><!-- content -->
	 <br>
	 <center>
	  
	 <iframe id="iframe4" width="60%" height="800px" src="../bbs/board.php?bo_table=plantinfo" name="mainframe3"  scrolling="no" style="border:0px solid #ddd; scrolling=no" frameborder="0"></iframe>
